...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("DeadPlayersIDLis")));
bytes32 constant DeadPlayersIDListTableId = _tableId;

library DeadPlayersIDList {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("DeadPlayersIDList", _fieldNames);
  }
