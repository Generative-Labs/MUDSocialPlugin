...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("PlayersIDList")));
bytes32 constant PlayersIDListTableId = _tableId;

library PlayersIDList {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("PlayersIDList", _fieldNames);
  }
