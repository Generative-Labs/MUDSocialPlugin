...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("WolfmanCount")));
bytes32 constant WolfmanCountTableId = _tableId;

library WolfmanCount {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("WolfmanCount", _fieldNames);
  }
