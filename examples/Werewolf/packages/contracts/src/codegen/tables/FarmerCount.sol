...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("FarmerCount")));
bytes32 constant FarmerCountTableId = _tableId;
...
library FarmerCount {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("FarmerCount", _fieldNames);
  }
