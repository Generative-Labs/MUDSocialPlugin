...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("GroupChatID")));
bytes32 constant GroupChatIDTableId = _tableId;
...
library GroupChatID {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("GroupChatID", _fieldNames);
  }
